 ...
 */
public class CandyPacketUnstable {
	 ...
	 */
	public CandyPacketUnstable(byte brand) {
		this();
		sweets[0] = brand;
	}
	 ...
	 */
	public CandyPacketUnstable(byte brand, int pretzel0) {
		this(brand);
	 ...
	 */
	public CandyPacketUnstable(byte brand, int pretzel0, int pretzel1) {
		this(brand, pretzel0);
	 ...
	 */
	public CandyPacketUnstable(byte brand, int pretzel0, int pretzel1, int pretzel2) {
	 ...
	 */
	public CandyPacketUnstable(byte brand, int pretzel0, int pretzel1, int pretzel2, int pretzel3) {
	 ...
	 */
	public CandyPacketUnstable(byte [] sweets) {
		this();
		for (int i = 0; i < PACKET_SIZE; ++i) {
