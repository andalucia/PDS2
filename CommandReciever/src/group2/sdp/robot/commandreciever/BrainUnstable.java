 ...
 * Alfie's brain
 * 
 * This class is Alfie's brain and controls all Alfie's thoughts and actions,
 * methods from this class should be called by the Client (Alfie's ears)
 * 
 ...
 * @author hanbing
 * 
 * two sensor LEFT_TOUCH_SENSOR and RIGHT_TOUCH_SENSOR
 * touch-sensor thread "StopByTouch".
 * flag "Sensor_Switch" for thread
 * new function spinToLeft and spinToRight
 * remove speed from spin
 *
 */
...
public class BrainUnstable {
	...
	/**
	 * All methods in this class are static so there is no constructor. This
	 * method should be called before running any other methods in the class.
	 */
	...
	// use pilot.rotate function. don't need to set speed.
	public static void spin(int angle) {
		assert (initialized);
	 ...
	 * 
	 * @param power
	 *            How hard should the motor rotate in degrees/s.
	 */
