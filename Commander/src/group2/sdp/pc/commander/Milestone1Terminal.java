 ...
 */
public class Milestone1Terminal {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Milestone1Terminal window = new Milestone1Terminal();
	...
	private void initializeFrame() {
		...
		frmAlfieCommandCentre.setTitle("Alfie Command Centre: Milestone 1");
		...
		btnTakePenalty.setBounds(166, 329, 142, 25);
		...
		btnGoForward.setBounds(12, 329, 142, 25);
